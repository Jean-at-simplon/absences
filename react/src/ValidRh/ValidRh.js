...
import { Container, Divider, Table, Header, Form, Input, Grid, Button } from "semantic-ui-react";
...
export default class AdminPage extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(`/validation/listeAbsencesRh?email=`+serviceRh+'&statut=2')
            .then(res => {
                this.setState({
                absences: res.data
                });
